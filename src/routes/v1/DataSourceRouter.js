...
const Schema = require('../../schema/DataSourceSchema');
const router = Router();

const FUNCTION_ID = Constant.FUNCTION_ID_DATA_SOURCE;
...
router.get('/default', JwtFilter, PermissionFilter(FUNCTION_ID, Constant.ACTION_READ), Controller.getDefault);
router.put('/set-default', JwtFilter, PermissionFilter(FUNCTION_ID, Constant.ACTION_UPDATE), celebrate({ body: Schema.setDefaultParamSchema }), Controller.setDefault);
